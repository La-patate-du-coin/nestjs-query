...
`@la-patate-du-coin/nestjs-query-graphql` provides a number of types. Most will be automatically generated for you when you create a
...
```ts
import { FilterableField, IDField } from '@la-patate-du-coin/nestjs-query-graphql'
...
```ts
import { DeleteManyResponseType } from '@la-patate-du-coin/nestjs-query-graphql'
...
GraphQL implementation of the `@la-patate-du-coin/nestjs-query-core` `Filter` type.
...
```ts
import { FilterType } from '@la-patate-du-coin/nestjs-query-graphql'
import { TodoItemDTO } from './dto/todo-item.dto'
...
```ts
import { UpdateOneInputType } from '@la-patate-du-coin/nestjs-query-graphql'
import { InputType } from '@nestjs/graphql'
import { TodoItemDTO } from './dto/todo-item.dto'
...
```ts
import { CreateOneInputType, FilterType } from '@la-patate-du-coin/nestjs-query-graphql'
import { InputType } from '@nestjs/graphql'
import { TodoItemDTO } from './dto/todo-item.dto'
...
```ts
import { DeleteOneInputType } from '@la-patate-du-coin/nestjs-query-graphql'
import { InputType } from '@nestjs/graphql'
import { TodoItemDTO } from './dto/todo-item.dto'
