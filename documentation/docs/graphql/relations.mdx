...
`@la-patate-du-coin/nestjs-query-graphql` will then automatically create the following graphql definition:
...
```ts title="sub-task/sub-task.dto.ts" {6}
import { FilterableField, IDField, FilterableRelation } from '@la-patate-du-coin/nestjs-query-graphql'
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql'
import { TodoItemDTO } from '../todo-item/todo-item.dto.ts'
...
import { FilterableField, IDField, UnPagedRelation } from '@la-patate-du-coin/nestjs-query-graphql'
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql'
...
```ts title="sub-task/sub-task.dto.ts" {6}
import { FilterableField, IDField, FilterableUnPagedRelation } from '@la-patate-du-coin/nestjs-query-graphql'
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql'
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, OffsetConnection } from '@la-patate-du-coin/nestjs-query-graphql'
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql'
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
import { FilterableField, IDField, FilterableOffsetConnection, QueryOptions } from '@la-patate-du-coin/nestjs-query-graphql'
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql'
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.module.ts"
import { PagingStrategies } from '@la-patate-du-coin/nestjs-query-core'
import { NestjsQueryGraphQLModule } from '@la-patate-du-coin/nestjs-query-graphql'
import { NestjsQueryTypeOrmModule } from '@la-patate-du-coin/nestjs-query-typeorm'
import { Module } from '@nestjs/common'
import { TodoItemDTO } from './todo-item.dto'
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, CursorConnection } from '@la-patate-du-coin/nestjs-query-graphql'
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql'
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, Connection } from '@la-patate-du-coin/nestjs-query-graphql'
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql'
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, FilterableCursorConnection } from '@la-patate-du-coin/nestjs-query-graphql'
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql'
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
import { ReadResolver, Relatable } from '@la-patate-du-coin/nestjs-query-graphql'
