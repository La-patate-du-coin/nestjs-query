...
This method leverages the `transformQuery` function from `@la-patate-du-coin/nestjs-query-core`. This method will remap all fields specified in the field map to correct field name.
