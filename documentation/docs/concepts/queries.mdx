...
The core of `nestjs-query` is the `Query`, it is used by `@la-patate-du-coin/nestjs-query-graphql` and `@la-patate-du-coin/nestjs-query-typeorm`.
...
sets. For more info see this [issue](https://github.com/La-patate-du-coin/nestjs-query/issues/954)
