...
import { getQueryServiceToken } from '@la-patate-du-coin/nestjs-query-core'
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        // Mock the SubTask QueryService using the `getQueryServiceToken` from @la-patate-du-coin/nestjs-query-core
        {
